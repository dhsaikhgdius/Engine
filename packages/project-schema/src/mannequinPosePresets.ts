...
import type { CharacterRigState } from "./directorProject";
import { CHARACTER_POSE_CONTROL_KEYS, POSE_PRESET_IDS, type PosePresetId } from "./poseSchema";

/** A single pose preset definition with its id, display label, and control values. */
...
/** Runtime-validated array of all mannequin pose preset definitions. */
...
/**
 * Looks up a pose preset definition by its id.
 *
 * @param presetId - The preset id to look up, or null/undefined.
 * @returns The matching preset definition, or null if not found.
 */
