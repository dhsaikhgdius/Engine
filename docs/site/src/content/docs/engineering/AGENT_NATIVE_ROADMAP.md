...
1. Finish remaining M3: the optional read-only mode (policy on raw HTTP/CLI, the unified audit trail, confirmation boundaries, and role-gated UI shipped 2026-08-25)
