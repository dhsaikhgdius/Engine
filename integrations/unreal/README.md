...
| `director_sequencer.py`      | shot classify (CLI) | LevelSequence authoring: display rate, tick resolution, start timecode, camera cuts (typed shot omissions), transform and focal-length tracks |
