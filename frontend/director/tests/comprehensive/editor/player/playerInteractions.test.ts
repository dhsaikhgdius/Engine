...
import {
  selectNearestPlayerInteraction,
  type PlayerInteractionCandidate,
} from "../../../../src/comprehensive/editor/player/playerInteractions";
...
it("ignores candidates outside the planar or vertical interaction range", () => {
  ...
  expect(selectNearestPlayerInteraction([{ ...candidates[1]!, position: [1, 8, 0] }], [0, 0, 0])).toBeNull();
});
