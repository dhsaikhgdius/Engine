...
/** Contract identifier for the Blender scene export manifest. */
...
/**
 * The manifest for a Blender scene export, describing the .blend source,
 * timeline, cameras, scene objects, and a GLB bundle for renderable geometry.
 */
...
/** User selection of which Blender scene elements to import. */
...
/**
 * An import plan generated from a Blender scene manifest.
