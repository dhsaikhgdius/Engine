import { CHARACTER_BODY_LABEL_ANCHOR_Y } from "@director/project-schema";
import {
  BODY_TYPE_OPTIONS,
  ...
  getGroundedLabelY,
  normalizeBodyType,
} from "../../../../../src/comprehensive/editor/runtime/mannequin/bodyTypes";
...
it("expresses the expected visible size relationships", () => {
  ...
  CHARACTER_BODY_PRESETS.forEach((preset) => {
    expect(preset.labelAnchorY).toBe(CHARACTER_BODY_LABEL_ANCHOR_Y[preset.bodyType]);
  });
});
