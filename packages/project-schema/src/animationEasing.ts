...
/** Named CSS cubic-bezier presets available to authoring tools and agents. */
...
/**
 * Resolves the effective 0–1 weight for a keyframe interpolation segment.
 *
 * Step interpolation snaps to the left key; smooth interpolation uses
 * Hermite easing; a timing curve delegates to the cubic-bezier solver.
 *
 * @param interpolation - The authored interpolation mode, defaulting to linear.
 * @param progress - The raw 0–1 fraction between the two keyframes.
 * @param timingCurve - Optional CSS cubic-bezier override for this segment.
 * @returns The resolved 0–1 weight to apply for blending.
 */
